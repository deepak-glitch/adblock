...
The app bundles **all the curated blocklists** (199 streaming-specific ad/tracker domains, plus the Google IMA SDK that hits almost every streamer).
...
│       │   ├── BlocklistManager.kt # Loads + matches blocklists
│       │   ├── Stats.kt            # Persistent counters
│       │   ├── Settings.kt         # Mode + auto-start prefs
